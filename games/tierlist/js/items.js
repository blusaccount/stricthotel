...
var ITEM_CATALOG = [
    ...
    { name: 'Ice Cream', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Ice_cream_with_whipped_cream%2C_chocolate_sauce_and_a_wafer.jpg/250px-Ice_cream_with_whipped_cream%2C_chocolate_sauce_and_a_wafer.jpg', category: 'food' },
    { name: 'Ramen', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Shoyu_ramen%2C_at_Kasukabe_Station_%282014.05.05%29.jpg/250px-Shoyu_ramen%2C_at_Kasukabe_Station_%282014.05.05%29.jpg', category: 'food' },
    { name: 'Croissant', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/28/Croissant%2C_August_2018.jpg/250px-Croissant%2C_August_2018.jpg', category: 'food' },
    { name: 'Steak', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Beef_steak.jpg/250px-Beef_steak.jpg', category: 'food' },
    ...
    { name: 'Döner Kebab', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/D%C3%B6ner_kebab.jpg/250px-D%C3%B6ner_kebab.jpg', category: 'food' },
    ...
    { name: 'Pancakes', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/43/Blueberry-Pancakes.jpg/250px-Blueberry-Pancakes.jpg', category: 'food' },
    ...
    { name: 'Dim Sum', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Dim_Sum_-_Hong_Kong.jpg/250px-Dim_Sum_-_Hong_Kong.jpg', category: 'food' },
    { name: 'Curry', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Chicken_tikka_masala.jpg/250px-Chicken_tikka_masala.jpg', category: 'food' },
    { name: 'Pasta', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Spaghetti_al_pomodoro.jpg/250px-Spaghetti_al_pomodoro.jpg', category: 'food' },
    { name: 'Waffles', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Gaufre_li%C3%A9geoise_2.jpg/250px-Gaufre_li%C3%A9geoise_2.jpg', category: 'food' },
    { name: 'Nachos', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/NachosPicture.jpg/250px-NachosPicture.jpg', category: 'food' },
    ...
    { name: 'Bubble Tea', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Bubble_Tea.png/250px-Bubble_Tea.png', category: 'food' },
    { name: 'Pretzel', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Pretzel_7948.jpg/250px-Pretzel_7948.jpg', category: 'food' },
    { name: 'Baklava', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Baklava_-_Turkish_special%2C_80-layer.jpg/250px-Baklava_-_Turkish_special%2C_80-layer.jpg', category: 'food' },
    { name: 'Tiramisu', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Tiramis%C3%B9_-_Raffaele_Diomede.jpg/250px-Tiramis%C3%B9_-_Raffaele_Diomede.jpg', category: 'food' },
    { name: 'Popcorn', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Popcorn02.jpg/250px-Popcorn02.jpg', category: 'food' },
    { name: 'Avocado', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Avocado_with_cross_section_edit.jpg/250px-Avocado_with_cross_section_edit.jpg', category: 'food' },
    ...
    { name: 'Skateboarding', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/16/Skateboarding_at_the_2020_Summer_Olympics_%E2%80%93_Women%27s_park_%28Tony_Lam%29_17_%28cropped2%29.jpg/250px-Skateboarding_at_the_2020_Summer_Olympics_%E2%80%93_Women%27s_park_%28Tony_Lam%29_17_%28cropped2%29.jpg', category: 'sports' },
    ...
    { name: 'Boxing', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Boxing_060.jpg/250px-Boxing_060.jpg', category: 'sports' },
    ...
    { name: 'Archery', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/43/Archery_competition.jpg/250px-Archery_competition.jpg', category: 'sports' },
    ...
    { name: 'Hawaii', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/Na_Pali_Coast%2C_Kauai%2C_Hawaii_-_panoramio.jpg/250px-Na_Pali_Coast%2C_Kauai%2C_Hawaii_-_panoramio.jpg', category: 'places' },
    ...
    { name: 'Barcelona', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Barcelona_-_Sagrada_Familia_01.jpg/250px-Barcelona_-_Sagrada_Familia_01.jpg', category: 'places' },
    ...
    // ─── MUSIC & INSTRUMENTS ───
    { name: 'Electric Guitar', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/GuitareElectrique.png/250px-GuitareElectrique.png', category: 'music' },
    ...
    { name: 'Drums', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Platin_Drums.jpg/250px-Platin_Drums.jpg', category: 'music' },
    ...
    { name: 'Turntable', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Technics_SL-1200MK2.jpg/250px-Technics_SL-1200MK2.jpg', category: 'music' },
    ...
    { name: 'Popcorn Cinema', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cb/CinemaNaarden2.jpg/250px-CinemaNaarden2.jpg', category: 'entertainment' },
    { name: 'Board Games', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Monopoly_board_on_white_bg.jpg/250px-Monopoly_board_on_white_bg.jpg', category: 'entertainment' },
    ...
    { name: 'Mechanical Keyboard', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/ANSI_US_Keyboard.svg/250px-ANSI_US_Keyboard.svg.png', category: 'tech' },
    { name: 'Telescope', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Usno-telescope.jpg/250px-Usno-telescope.jpg', category: 'tech' },
    ...
    { name: 'Motorcycle', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/2018_Kawasaki_Ninja_400.jpg/250px-2018_Kawasaki_Ninja_400.jpg', category: 'vehicles' },
    ...
    { name: 'Cable Car', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/San_Francisco_Cable_Car_MC.jpg/250px-San_Francisco_Cable_Car_MC.jpg', category: 'vehicles' },
    ...
    { name: 'Typewriter', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a1/Schreibmaschine_Adler_-_no_border.jpg/250px-Schreibmaschine_Adler_-_no_border.jpg', category: 'random' },
    ...
    { name: 'Spring Garden', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/85/Keukenhof_Garden.jpg/250px-Keukenhof_Garden.jpg', category: 'seasonal' },
    { name: 'Bonfire', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Campfire_4213.jpg/250px-Campfire_4213.jpg', category: 'seasonal' },
    ...
    { name: 'Eagle', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Bald_Eagle_Portrait.jpg/250px-Bald_Eagle_Portrait.jpg', category: 'animals' },
    ...
    { name: 'Sewing Machine', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Sewingmachine1.jpg/250px-Sewingmachine1.jpg', category: 'random' }
];
